package com.snow.common.lang;


import com.snow.common.io.ByteArrayOutputStream;
import com.snow.common.util.ExceptionUtil;
import com.snow.common.util.StringUtil;
...
public class UUID {
    ...
    public static void main(String[] args) {
        System.out.println(new UUID().nextID());
    }
}
